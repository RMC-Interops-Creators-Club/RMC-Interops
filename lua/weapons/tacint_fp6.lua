...
SWEP.Description = "Advanced 12 gauge tactical shotgun that performs well even at range. 8 pellets."
...
SWEP.Range_Max = 510 // distance at which we drop to minimum damage
...
SWEP.Attachments = {
    ...
    [3] = {
        PrintName = "Perk",
        Category = {"perk", "perk_melee", "perk_shooting", "perk_reload", "perk_slug"},
        AttachSound = "tacint/weapons/flashlight_on.wav",
        DetachSound = "tacint/weapons/flashlight_off.wav",
    },
}
