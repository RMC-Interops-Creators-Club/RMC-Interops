...
local fastspread = function(base, val)
...
function SWEP:CreateCustomizeHUD()
    ...
    bg.Paint = function(self2, w, h)
        ...
        surface.SetFont("TacInt_Myriad_Pro_32")
        ...
        TacInt.DrawCorneredBox(w - name_w - ScreenScale(20), airgap, name_w + ScreenScale(12), ScreenScale(34))
    ...
    if !self:GetValue("NoRanger") then
        ...
        ranger.Paint = function(self2, w, h)
            ...
            TacInt.DrawCorneredBox(0, 0, w, h)
    ...
    desc_box.Paint = function(self2, w, h)
        ...
        local txt = multlinetext(self:GetValue("Description"), w - ScreenScale(6 * 2), "TacInt_Myriad_Pro_8")
    ...
    local stats = {
        ...
        },
        {
            ...
            AggregateFunction = function(base)
                return math.Round(self:GetReloadTime(base), 1)
            end,
        ...
        },
        {
            Name = "Deploy Time",
            AggregateFunction = function(base)
                return math.Round(self:GetDeployTime(base), 1)
            end,
    ...
    for slot, attslot in pairs(self.Attachments) do
        local atts = TacInt.GetAttsForCats(attslot.Category or "")
        ...
        table.sort(atts, function(a, b)
            ...
            local atttbl_a = TacInt.GetAttTable(a)
            local atttbl_b = TacInt.GetAttTable(b)
        ...
        for i, att in pairs(atts) do
            ...
            slot_panel.Paint = function(self2, w, h)
                ...
                local has = TacInt:PlayerGetAtts(self:GetOwner(), att)

                local shownum = !GetConVar("tacint_lock_atts"):GetBool() and !GetConVar("tacint_free_atts"):GetBool() and !atttbl.Free
                ...
                if attached then
                    ...
                    if GetConVar("tacint_free_atts"):GetBool() or has > 0 then
                        if hover then
                            col_bg = Color(255, 255, 255)
                ...
                surface.DrawRect(0, 0, w, h)
                TacInt.DrawCorneredBox(0, 0, w, h, col_corner)
                ...
                if hover then
                    ...
                    if atttbl.Pros then for aa, ab in ipairs(atttbl.Pros) do
                        ...
                        TacInt.DrawCorneredBox( rx, ry + bump, bw, ScreenScale(10) )
                        surface.SetFont("TacInt_Myriad_Pro_8")
                        surface.SetTextColor(col_text)
